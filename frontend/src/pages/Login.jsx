    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
        ...
        <div className="bg-green-600 text-white p-8 text-center">
          ...
          <p className="text-green-100 text-sm">Comptabilité Matière - ENI</p>
        </div>
        ...
        <div className="p-8">
          ...
          <div className="mt-6 text-center space-y-3">
            <a href="/forgot-password" className="block text-green-600 hover:text-green-700 text-sm font-medium">
              Mot de passe oublié ?
            </a>
